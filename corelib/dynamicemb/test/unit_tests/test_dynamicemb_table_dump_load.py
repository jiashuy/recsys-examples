...
# @pytest.mark.parametrize("dump_key_type", ["int64", "uint64"])
# @pytest.mark.parametrize("dump_value_type", ["float32", "float16", "bfloat16"])
# @pytest.mark.parametrize("dump_score_type", ["uint64"])
# @pytest.mark.parametrize("dump_optimizer_type", ["sgd", "adam", "adagrad", "rowwise_adagrad"])
# @pytest.mark.parametrize("dump_score_strategy", ["timestamp", "step", "custimized"])
# @pytest.mark.parametrize("dump_mode", ["training", "evaluation"])
# @pytest.mark.parametrize("load_key_type", ["int64", "uint64"])
# @pytest.mark.parametrize("load_value_type", ["float32", "float16", "bfloat16"])
# @pytest.mark.parametrize("load_score_type", ["uint64"])
...
@pytest.mark.parametrize("value_type", ["float32"])
